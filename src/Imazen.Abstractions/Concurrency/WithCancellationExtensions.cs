...
/// </summary>
internal static class WithCancellationExtensions
{
    ...
    public static bool ApplyChangeOptimistically<T>(ref T hotLocation, Func<T, T> applyChange)
        where T : class?
    {
        ArgumentNullThrowHelper.ThrowIfNull(applyChange, nameof(applyChange));
    ...
    {
        ArgumentNullThrowHelper.ThrowIfNull(taskCompletionSource, nameof(taskCompletionSource));
    ...
    {
        ArgumentNullThrowHelper.ThrowIfNull(task);
        if (!cancellationToken.CanBeCanceled)
        {
            throw new InvalidOperationException("The cancellation token must be cancellable.");
        }
